...
public:
  ...
  **/
  ...
  /**
     ...
     **/
  bool contains(ItemType* an_entry) const;

  /**
    @return the number of times an_entry is found in items_
  **/
  int getFrequencyOf(ItemType* an_entry) const;
...
protected:
  ...
  /**
     ...
     **/
  int getIndexOf(ItemType* target) const;
