 ...
 **/
template<class ItemType>
bool ArrayBag<ItemType>::add(ItemType* new_entry)
{
 ...
 **/
template<class ItemType>
bool ArrayBag<ItemType>::remove(ItemType* an_entry)
{
 ...
 **/
template<class ItemType>
int ArrayBag<ItemType>::getFrequencyOf(ItemType* an_entry) const
{
   int frequency = 0;
 ...
 **/
template<class ItemType>
bool ArrayBag<ItemType>::contains(ItemType* an_entry) const
{
 ...
 **/
template<class ItemType>
int ArrayBag<ItemType>::getIndexOf(ItemType* target) const
{  
	bool found = false;
  int result = -1;
  int search_index = 0;
